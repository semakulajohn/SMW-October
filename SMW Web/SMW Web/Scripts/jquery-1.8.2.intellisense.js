...
intellisense.annotate(jQuery.fn, {
  ...
  'off': function() {
    ...
    ///   <param name="events" type="String">One or more space-separated event types and optional namespaces, or just namespaces, such as "click", "keydown.OurPlugin", or ".OurPlugin".</param>
  ...
  'on': function() {
    ...
    ///   <param name="events" type="String">One or more space-separated event types and optional namespaces, such as "click" or "keydown.OurPlugin".</param>
