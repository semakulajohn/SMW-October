...
namespace SMW.Admin.Controllers
{
    public class MediaApiController : ApiController
    {
        ...
        public MediaApiController(IMediaService mediaService, ICommentService commentService, IUserService userService)
        {
        ...
        {
            return _commentService.SaveComment(comment, userId);
        }
        ...
        {
            _commentService.MarkAsDeleted(commentId, userId);
        }
